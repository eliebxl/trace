...
function trace_main_nav() {
  wp_nav_menu(
    array(
      ...
      'container'      => 'false',
      'fallback_cb'    => 'trace_main_nav_fallback',
      'walker'         => new Bootstrap_walker()
    )
  );
}

function trace_main_nav_fallback() {
}

function trace_support() {
...
add_action('after_setup_theme', 'trace_support');

function trace_assets() {
  global $wp_styles;
...
add_action('wp_enqueue_scripts', 'trace_assets', 999);

function trace_paging() {
  global $wp_query;
  $bignum = 999999999;
